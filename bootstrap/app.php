...
$app->configure('laravel-log-reader');
/*
|--------------------------------------------------------------------------
| Register Middleware
|--------------------------------------------------------------------------
...
$app->register(\Haruncpi\LaravelLogReader\ServiceProvider::class);
...
$app->router->group(['namespace' => 'App\Http\Controllers\Employee'], function ($router) {
    require __DIR__ . '/../routes/employee.php';
});

$app->router->group(['namespace' => 'App\Http\Controllers\Employer'], function ($router) {
    require __DIR__ . '/../routes/employer.php';
});
