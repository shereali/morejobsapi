...
"row", "cell"], function (a, b) {
    ...
    h.extend(m.ext.classes, {
        sTable: "dataTable",
        sNoFooter: "no-footer",
        sPageButton: "paginate_button ripple rpcolor",
        sPageButtonActive: "current",
        sPageButtonDisabled: "disabled",
        sStripeOdd: "odd fadeInRow",
        sStripeEven: "even fadeInRow",
        sRowEmpty: "dataTables_empty",
        sWrapper: "dataTables_wrapper",
        sFilter: "dataTables_filter pull-left mb20 ",
        sInfo: "dataTables_info",
        sPaging: "dataTables_paginate pull-right fadeInRow paging_ pull-right",
